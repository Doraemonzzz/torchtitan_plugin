# credit to: https://github.com/pytorch/torchtitan
...
def maybe_enable_profiling(config: JobConfig, *, global_step: int = 0):
    ...
    if enable_profiling:
        ...
        def trace_handler(prof):
            ...
            logging_info(f"Dumping traces at step {prof.step_num}")
        ...
        logging_info(f"Profiling active. Traces will be saved at {trace_dir}")
    ...
    if enable_snapshot:
        ...
        class MemoryProfiler:
            ...
            def step(self, exit_ctx: bool = False):
                ...
                logging_info(f"Dumping memory snapshot at step {curr_step}")
                begin = time.monotonic()
                with open(
